    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                {!! \Form::open(['route' => 'core.login', 'id' => 'login-form', 'method' => 'post']) !!}
            ...
            <!-- /.social-auth-links -->
                ...
                @if(Route::has('core.register') && config('auth.allow_register'))
                    <p class="mb-0">
                        <a href="{{ route('core.register') }}" class="text-center">Register a new membership</a>
                    </p>
                @endif
            </div>
            <!-- /.login-card-body -->
